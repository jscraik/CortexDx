...
for (const file of files) {
  ...
  content = content.replace(
    /from ["']\.\.\/utils\//g,
    'from "@brainwav/cortexdx-core/utils/',
  );
  content = content.replace(
    /from ["']\.\.\/\.\.\/utils\//g,
    'from "@brainwav/cortexdx-core/utils/',
  ...
  content = content.replace(
    /from ["']\.\.\/logging\//g,
    'from "@brainwav/cortexdx-core/logging/',
  );
  content = content.replace(
    /from ["']\.\.\/\.\.\/logging\//g,
    'from "@brainwav/cortexdx-core/logging/',
  ...
  content = content.replace(
    /from ["']\.\.\/config\//g,
    'from "@brainwav/cortexdx-core/config/',
  );
  content = content.replace(
    /from ["']\.\.\/\.\.\/config\//g,
    'from "@brainwav/cortexdx-core/config/',
  ...
  content = content.replace(
    /from ["']\.\.\/plugins\//g,
    'from "@brainwav/cortexdx-plugins/plugins/',
  );
  content = content.replace(
    /from ["']\.\.\/\.\.\/plugins\//g,
    'from "@brainwav/cortexdx-plugins/plugins/',
  ...
  content = content.replace(
    /from ["']\.\.\/adapters\//g,
    'from "@brainwav/cortexdx-plugins/adapters/',
  );
  content = content.replace(
    /from ["']\.\.\/\.\.\/adapters\//g,
    'from "@brainwav/cortexdx-plugins/adapters/',
