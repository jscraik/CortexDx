...
Templates are stored in `.cortexdx/templates/`:
...
The brAInwav Constitution (`.cortexdx/templates/constitution-template.md`) defines foundational principles:
...
- **brAInwav Constitution**: `.cortexdx/templates/constitution-template.md`
