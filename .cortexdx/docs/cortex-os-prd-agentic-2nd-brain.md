...
14. Governance & CI Gates
 • .cortexdx/ is SoT: rules, policy, schemas, gates.
...
Appendix A: Subagents live in .cortexdx/agents/*.md with YAML frontmatter. They inherit tools unless restricted. Policies control privacy, cost ceilings, and target latency. Cerebrum selects automatically or via CLI cortex use <name>.
