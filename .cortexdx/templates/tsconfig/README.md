...
**Location**: `.cortexdx/templates/tsconfig/`  
...
cp .cortexdx/templates/tsconfig/tsconfig.spec.json packages/my-package/tsconfig.spec.json
...
```bash
cp ../../.cortexdx/templates/tsconfig/tsconfig.lib.json tsconfig.json
```
...
# Copy test config
cp ../../.cortexdx/templates/tsconfig/tsconfig.spec.json tsconfig.spec.json
```
...
2. **Copy template**: `cp .cortexdx/templates/tsconfig/tsconfig.lib.json tsconfig.json`
