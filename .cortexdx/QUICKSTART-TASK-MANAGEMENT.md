...
- **Complete Guide**: `.cortexdx/docs/task-management-guide.md`
- **Templates**: `.cortexdx/templates/` (Constitution, Spec, Research, TDD Plan)
- **Template Docs**: `.cortexdx/templates/README.md`
...
2. Check `.cortexdx/docs/task-management-guide.md` for detailed workflow
3. Review `.cortexdx/templates/README.md` for template documentation
