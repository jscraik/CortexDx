...
└── [feature-name]/              # Use descriptive slugs: copilot-enhancement, brainwav-integration
    ...
    │   └── reuse-evaluation.md # Filled from /.cortexdx/templates/reuse-evaluation-template.md
...
- `analysis/reuse-evaluation.md` - Reuse-first investigation log (template: `/.cortexdx/templates/reuse-evaluation-template.md`) covering candidates assessed, decisions, evidence links, and mitigation tickets.
