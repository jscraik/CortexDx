...
export function LogsPanel() {
  ...
  const logs: LogEntry[] = [
    {
      id: "1",
      timestamp: "2023-11-25 10:30:01",
      level: "info",
      message: "Agent initialized successfully",
    },
    {
      id: "2",
      timestamp: "2023-11-25 10:30:05",
      level: "debug",
      message: "Loading context from vector store",
    },
    {
      id: "3",
      timestamp: "2023-11-25 10:31:12",
      level: "warn",
      message: "Response time > 500ms",
    },
    {
      id: "4",
      timestamp: "2023-11-25 10:32:45",
      level: "info",
      message: "User request processed",
    },
    {
      id: "5",
      timestamp: "2023-11-25 10:35:00",
      level: "error",
      ...
      <div className="flex-1 bg-cortex-bg rounded-xl border border-cortex-border shadow-inner overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-auto p-4 space-y-1 font-mono text-sm custom-scrollbar">
          {filteredLogs.map((log) => (
            <div
              key={log.id}
              className="flex gap-4 hover:bg-cortex-surface/50 p-1.5 rounded transition-colors duration-150 group"
            >
              <span className="text-cortex-muted min-w-[150px] select-none">
                {log.timestamp}
              </span>
              <span
                className={`
              ...
              <span className="text-cortex-text group-hover:text-white transition-colors">
                {log.message}
              </span>
            </div>
          ))}
