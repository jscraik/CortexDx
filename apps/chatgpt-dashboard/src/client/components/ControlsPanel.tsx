        ...
        <div className="bg-cortex-surface rounded-xl border border-cortex-border shadow-sm overflow-hidden">
          <table className="min-w-full divide-y divide-cortex-border">
            <thead className="bg-cortex-bg/50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-bold text-cortex-muted uppercase tracking-wider font-display">
                  Run ID
                </th>
                <th className="px-6 py-3 text-left text-xs font-bold text-cortex-muted uppercase tracking-wider font-display">
                  Workflow
            ...
            <tbody className="bg-cortex-surface divide-y divide-cortex-border">
              <tr>
                <td
                  className="px-6 py-8 text-sm text-cortex-muted text-center italic"
                  colSpan={4}
                >
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-4">
          <Button
            variant="outline"
            color="warning"
            className="border-cortex-warning/50 text-cortex-warning hover:bg-cortex-warning/10 transition-colors"
          >
          ...
          <Button
            variant="outline"
            color="success"
            className="border-cortex-success/50 text-cortex-success hover:bg-cortex-success/10 transition-colors"
          >
          ...
          <Button
            variant="outline"
            color="danger"
            className="border-cortex-danger/50 text-cortex-danger hover:bg-cortex-danger/10 transition-colors"
          >
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-2">
              <label
                ...
                className="block text-sm font-medium text-cortex-text"
              >
                MCP Endpoint
              </label>
              <Input
            ...
            <Button
              type="submit"
              color="primary"
              className="w-full bg-cortex-accent hover:bg-cortex-accent-hover text-white shadow-lg shadow-cortex-accent/20 transition-all duration-200 hover:scale-[1.02]"
            >
