...
mcpServer.addTool({
  ...
  parameters: z.object({
    ...
    since: z
      .string()
      .optional()
      .describe("Filter logs since timestamp (ISO 8601)"),
  }),
...
mcpServer.addTool({
  ...
  parameters: z.object({
    limit: z
      ...
      .optional()
      .default(50)
      .describe("Number of traces to return"),
  }),
  execute: async (args: Record<string, unknown>) => {
...
mcpServer.addTool({
  ...
  parameters: z.object({
    action: z
      .enum(["pause", "resume", "cancel", "drain", "retry"])
      .describe("Action to execute"),
    targetId: z
      .string()
      .optional()
      .describe("Target ID for the action (e.g., run ID)"),
  }),
  execute: async (args: Record<string, unknown>) => {
