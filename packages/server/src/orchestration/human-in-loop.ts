...
export class HumanInLoopManager {
  ...
  async pauseWorkflow(
    ...
    const timeout =
      decisionPoint.prompt.timeout || this.timeoutConfig.defaultTimeoutMs;
   ...
   */
  createReviewPrompt(findings: Finding[], message?: string): UserPrompt {
    ...
    return this.createPrompt(
      ...
      message ||
        "Please review the diagnostic findings and decide how to proceed.",
      {
        context,
        choices: [
          {
