...
function findMatchingPatterns(
  ...
  return matches.sort((a, b) => {
    const scoreA =
      a.confidence * (a.successCount / (a.successCount + a.failureCount));
    const scoreB =
      b.confidence * (b.successCount / (b.successCount + b.failureCount));
...
function generatePatternRecommendation(patterns: ResolutionPattern[]): string {
