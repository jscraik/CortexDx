...
import { validateToolInput, createValidationErrorResult, createExecutionErrorResult } from '../src/utils/validation.js';
      ...
      const schema = {
        ...
        properties: {
          ...
          suites: {
            ...
            items: {
              type: 'string',
              enum: ['connectivity', 'security', 'governance', 'streaming', 'performance']
            },
