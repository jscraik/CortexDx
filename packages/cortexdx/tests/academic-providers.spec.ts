...
describe("Academic Providers Registry", () => {
  ...
  it("should create provider instances", () => {
    ...
    const semanticScholar = registry.createProviderInstance(
      "semantic-scholar",
      mockContext,
    );
  ...
  it("should handle tool execution", async () => {
    const registry = getAcademicRegistry();
    const researchQuality = registry.createProviderInstance(
      "research-quality",
      mockContext,
    );

    // Test a simple quality assessment
    const result = await researchQuality.executeTool(
...
describe("Provider Health Checks", () => {
  it("should perform health checks for local providers", async () => {
    ...
    const cortexVibe = registry.createProviderInstance(
      "cortex-vibe",
      mockContext,
    );
