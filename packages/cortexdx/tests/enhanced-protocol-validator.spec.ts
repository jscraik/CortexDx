...
import { CELRuleBuilder, CELRuleConfigLoader, CELRuleValidator, MCPCELRuleLibrary } from '../src/adapters/cel-rules.js';
import { ErrorFormatter, FieldErrorReporter } from '../src/adapters/field-error-reporter.js';
import { ProtovalidateAdapter, type CELRule } from '../src/adapters/protovalidate.js';
...
describe('Enhanced Protocol Validator', () => {
    ...
    describe('Integration Tests', () => {
        ...
        it('should generate comprehensive error report', async () => {
            ...
            const result = await adapter.validate(invalidMessage, rules);
            const errors = FieldErrorReporter.generateDetailedErrors(result.violations);
