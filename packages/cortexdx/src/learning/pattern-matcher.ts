...
export class EnhancedPatternMatcher {
        ...
        return [
            ...
            },
            {
                ...
                match: (problem, pattern) => {
                    ...
                    return this.calculateJaccardSimilarity(problemSig, pattern.problemSignature);
                },
            },
            {
            ...
            },
            {
                ...
                match: (problem, pattern) => {
                    ...
                    const patternKeywords = new Set(patternContext.toLowerCase().split(/\s+/));
    ...
    private determineMatchType(
        ...
        const structuralStrategies = ["problemType", "componentOverlap", "severityMatch"];
        ...
        for (const score of topScores) {
            switch (score.strategy) {
                ...
                case "contextSimilarity":
                    reasons.push(
                        `similar context (${(score.score * 100).toFixed(0)}%)`,
                    );
                    break;
            }
        }
