...
export class SemanticScholarProvider {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            year: {
              type: "string",
              description:
                "Publication year filter (e.g., '2020', '2020-2023')",
            },
            venue: {
              type: "array",
              items: { type: "string" },
            ...
            fieldsOfStudy: {
              ...
              items: { type: "string" },
              description:
                "Fields of study filter (e.g., ['Computer Science', 'Medicine'])",
            },
            minCitationCount: {
              type: "number",
            ...
            publicationTypes: {
              ...
              items: { type: "string" },
              description:
                "Publication types filter (e.g., ['JournalArticle', 'Conference'])",
            },
            openAccessPdf: {
              type: "boolean",
        ...
        inputSchema: {
          ...
          properties: {
            paperId: {
              type: "string",
              description:
                "Semantic Scholar paper ID, DOI, ArXiv ID, or other identifier",
            },
          },
          required: ["paperId"],
        },
        ...
        inputSchema: {
          ...
          properties: {
            ...
            limit: {
              type: "number",
              description:
                "Maximum number of citations (default: 10, max: 1000)",
              minimum: 1,
              maximum: 1000,
              default: 10,
            },
        ...
        inputSchema: {
          ...
          properties: {
            ...
            limit: {
              type: "number",
              description:
                "Maximum number of references (default: 10, max: 1000)",
              minimum: 1,
              maximum: 1000,
              default: 10,
            },
  ...
  async getPaperCitations(
    params: SemanticScholarCitationParams,
  ): Promise<SemanticScholarPaper[]> {
    const searchParams = new URLSearchParams({
      limit: String(params.limit || 10),
      offset: String(params.offset || 0),
   ...
   */
  async searchAuthors(
    params: SemanticScholarAuthorSearchParams,
  ): Promise<SemanticScholarAuthor[]> {
    const searchParams = new URLSearchParams({
      query: params.query,
      limit: String(params.limit || 10),
      offset: String(params.offset || 0),
  ...
  async validateCitations(
    ...
    if (checkLicense) {
      ...
      const licenseValidation =
        await this.licenseValidator.validateLicense(researchContent);
    ...
    if (checkLicense) {
      ...
      if (!licenseValidation.isValid) {
        verification.issues.push(
          `License compliance issue: ${licenseValidation.license}`,
        );
      }
    }
    ...
    switch (toolName) {
      case "semantic_scholar_search_papers":
        return await this.searchPapers({
          ...
          fieldsOfStudy: params.fieldsOfStudy as string[] | undefined,
          minCitationCount: params.minCitationCount as number | undefined,
          publicationTypes: params.publicationTypes as string[] | undefined,
          openAccessPdf: params.openAccessPdf as boolean | undefined,
        });
      ...
      case "semantic_scholar_get_paper_citations":
        return await this.getPaperCitations({
      ...
      case "semantic_scholar_get_paper_references":
        return await this.getPaperReferences({
          paperId: params.paperId as string,
          limit: params.limit as number | undefined,
          offset: params.offset as number | undefined,
          fields: params.fields as string[] | undefined,
      ...
      case "semantic_scholar_search_authors":
        return await this.searchAuthors({
          query: params.query as string,
          limit: params.limit as number | undefined,
          offset: params.offset as number | undefined,
          fields: params.fields as string[] | undefined,
      ...
      case "semantic_scholar_get_author_papers":
        return await this.getAuthorPapers(
  ...
  private async callRemoteTool<T>(
    ...
    try {
      ...
      this.ctx.evidence({
        type: "log",
        ref: `Semantic Scholar remote tool call: ${toolName}`,
      });
      return result;
    } catch (error) {
      this.ctx.logger?.(
        `[Semantic Scholar] Remote tool call failed for ${toolName}:`,
        error,
      );
      return undefined;
    }
...
/**
 * Initialize HTTP MCP client for Semantic Scholar
 */
function initializeSemanticScholarClient(
  ctx: DiagnosticContext,
): HttpMcpClient | undefined {
  if (process.env.CORTEXDX_DISABLE_SEMANTIC_SCHOLAR_HTTP === "1") {
    return undefined;
  }
  ...
  try {
    ...
    console.warn(
      "[Semantic Scholar] Failed to initialize HTTP MCP client:",
      error,
    );
    return undefined;
  }
