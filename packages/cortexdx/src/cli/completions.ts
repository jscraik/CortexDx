...
export function generateBashCompletion(
  ...
  const { name, description = "CLI completion" } = options;
 ...
 */
function getGlobalFlags(program: Command): Array<{ name: string; description: string }> {
...
export function generateSimpleCompletions(options: CompletionOptions): string {
  const { name, description = "CLI tool" } = options;
