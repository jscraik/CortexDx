...
**Authority**: This document is part of the Governance Pack (`/.insula/rules/`) and is binding for all agent and human activities involving skills.
...
Skills related to testing MUST align with `.insula/rules/testing-standards.md`:
...
Issues escalate per `.insula/rules/constitution.md`:
...
- `.insula/rules/agentic-coding-workflow.md` - Integration points
- `.insula/rules/testing-standards.md` - Testing skill standards
- `.insula/rules/CODESTYLE.md` - Code example standards
- `.insula/rules/RULES_OF_AI.md` - AI ethics and compliance
